...
module.exports = function InlineQueryResultCachedVideo(data) {
    ...
    let video_file_id = data['video_file_id'] ? data['video_file_id'] : null; /* A valid file identifier for the video file */
    ...
    let caption = data['caption'] ? data['caption'] : null; /* * Optional *. Caption of the video to be sent, 0-200 characters */
    ...
    let input_message_content = data['input_message_content'] ? data['input_message_content'] : null; /* * Optional *. Content of the message to be sent instead of the video */
